...
var LessFunks = map[string]search.LessFunction[*Group]{
	"id":        func(a, b *Group) bool { return a.ID.String() < b.ID.String() },
	"createdAt": func(a, b *Group) bool { return a.CreatedAt.Before(b.CreatedAt) },
	"updatedAt": func(a, b *Group) bool { return a.UpdatedAt.Before(b.UpdatedAt) },
}

func GetLessFunc(sortBy, sortOrder string) search.LessFunction[*Group] {
	...
	if sortOrder == "desc" {
		return func(a, b *Group) bool { return !fn(a, b) }
	}
	return fn
}

func BuildSearch(with *SearchOptions) search.Criteria[*Group] {

	return func(a *Group) bool {
...
func Search(items []*Group, with *SearchOptions) []*Group {

	// Build criteria
	criteria := BuildSearch(with)
