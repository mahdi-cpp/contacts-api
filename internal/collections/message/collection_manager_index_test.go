...
const databaseDirectory = "/app/tmp/messages"

func TestCreateMessages(t *testing.T) {

	db, err := collection_manager_index.New[*Message, *Index](databaseDirectory)
	if err != nil {
		t.Fatal(err)
	}
	defer db.Close()
...
func TestReadAll(t *testing.T) {
	...
	collection, err := collection_manager_json.New[*Message]("/app/tmp/messages/metadata")
	collectionIndex, err := collection_manager_json.New[*Index]("/app/tmp/messages/index")

	manager, err := collection_manager_index.New[*Message, *Index](databaseDirectory)
	if err != nil {
...
func TestReadMessages2(t *testing.T) {

	//db, err := New[*Message, *Index]()
	//if err != nil {
	//	t.Fatal(err)
	//}
	//defer db.Close()
