...
// PrivacySetting controls who can see the status's status
...
// StatusUpdateRequest is sent when status manually changes status
...
type StatusResponse struct {
	...
	CustomStatus string     `json:"custom_status,omitempty"`
	Visible      bool       `json:"visible"` // Whether this Status's Status is visible to requester
}
...
// StatusQuery is used to query status status from other services
...
// UserPrivacySettings stores all privacy preferences for a status
